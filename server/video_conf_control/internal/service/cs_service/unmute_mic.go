...
type unMuteMicParam struct {
	LoginToken string `json:"login_token"`
}

func unMuteMic(ctx context.Context, param *vc_control.TEventParam) {
	var p unMuteMicParam
	...
	user.GetRoom().Inform(ctx, cs_models.OnCsUnmuteMic, user.GenerateInformUserInfo())
}
