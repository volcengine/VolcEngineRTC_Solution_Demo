...
func openVideoInteract(ctx context.Context, param *vc_control.TEventParam) {
	logs.Infof("openVideoInteract:%+v", param)
	...
	room.InformRoom(ctx, edu_models.OnOpenVideoInteract, &edu_models.NoticeRoom{RoomID: p.RoomID})
