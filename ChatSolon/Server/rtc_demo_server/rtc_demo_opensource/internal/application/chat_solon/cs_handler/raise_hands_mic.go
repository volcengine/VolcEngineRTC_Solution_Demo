...
type raiseHandsMicReq struct {
	LoginToken string `json:"login_token"`
	RoomID     string `json:"room_id"`
	UserID     string `json:"user_id"`
}

type raiseHandsMicResp struct {
}

func (eh *EventHandler) RaiseHandsMic(ctx context.Context, param *public.EventParam) (resp interface{}, err error) {
	var p raiseHandsMicReq
	...
	err = interactService.RaiseHands(ctx, p.UserID)
	if err != nil {
