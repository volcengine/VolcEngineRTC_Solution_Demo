...
type agreeMicReq struct {
	LoginToken string `json:"login_token"`
	RoomID     string `json:"room_id"`
	UserID     string `json:"user_id"`
}

type agreeMicResp struct {
}

func (eh *EventHandler) AgreeMic(ctx context.Context, param *public.EventParam) (resp interface{}, err error) {
	var p agreeMicReq
	...
	err = interactService.Agree(ctx, p.UserID)
	if err != nil {
